...
<div class="w-full lg:w-1/2 mt-6 pl-0 lg:pl-2">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" action="route('clientes/save')">
            ...
            <div class="">
                ...
                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="birth" name="birth" type="date" required="">
            </div>
            <div class="">
                <label class="block text-sm text-gray-600" for="cellphone">Telefone</label>
                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="cellphone" name="cellphone" type="text" required="" placeholder="Telefone" aria-label="Telefone">
            </div>
            ...
            <div class="mt-2">
                <label class=" block text-sm text-gray-600" for="streat">Rua</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="streat" name="streat" type="text" required="" placeholder="Street" aria-label="Email">
            </div>
            <div class="mt-2">
                <label class="hidden text-sm block text-gray-600" for="city">Cidade</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="city" name="city" type="text" required="" placeholder="City" aria-label="Email">
            </div>
            <div class="mt-2">
                <label class="hidden text-sm block text-gray-600" for="district">Bairro</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="district" name="district" type="text" required="" placeholder="City" aria-label="Email">
            </div>
            <div class="inline-block mt-2 w-1/2 pr-1">
                <label class="hidden block text-sm text-gray-600" for="estate">Estado</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="estate" name="estate" type="text" required="" placeholder="Country" aria-label="Email">
            </div>
            <div class="inline-block mt-2 w-1/2 pr-1">
                <label class="hidden block text-sm text-gray-600" for="house">Nº:</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="house" name="house" type="text" required="" placeholder="Country" aria-label="Email">
            </div>
