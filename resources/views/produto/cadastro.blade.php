<x-app-layout>
    <h1 class="w-full text-3xl text-black pb-6">Cadastro de Produto</h1>
...
<div class="w-full mt-6 pl-0">
    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" action="{{url('produtos/save')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="inline-block mt-2 -mx-1 w-1/2">
                ...
                <input class="w-full px-2 py-1 text-gray-700 bg-gray-200 rounded" id="price" name="price" type="text" required="">
            </div>
