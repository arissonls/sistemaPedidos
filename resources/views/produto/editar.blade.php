    ...
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" action="{{url('produtos/edit').'/'.$produto->id}}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="mt-2">
                ...
                <textarea name="description" id="descricao" cols="30" rows="10">{{$produto->description}}</textarea>
            </div>
            ...
            <div class="inline-block mt-2 -mx-1 pl-2 w-1/2">
                ...
                <input class="w-full px-2 py-1 text-gray-700 bg-gray-200 rounded" id="slug" name="slug" type="file" required="" {{$produto->slug}}>
            </div>
